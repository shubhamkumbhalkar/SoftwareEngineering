...
<c:url value="/home_admin" var="homeUrl"/>
<c:url value="/course_admin" var="courseUrl"/>
<c:url value="/library_admin" var="libraryUrl"/>
<c:url value="/news_admin" var="newsUrl"/>
<c:url value="/academic_admin" var="academicUrl"/>
<c:url value="/emergency_admin" var="emergencyUrl"/>
<c:url value="/oncampus_admin" var="oncampusUrl"/>
<c:url value="/discussion_admin" var="discussionUrl"/>
<c:url value="/dining_admin" var="diningUrl"/>
